 ...
 */
const M = globalThis, D = M.ShadowRoot && (M.ShadyCSS === void 0 || M.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, j = Symbol(), V = /* @__PURE__ */ new WeakMap();
let tt = class {
  constructor(t, e, s) {
...
const ht = (r) => new tt(typeof r == "string" ? r : r + "", void 0, j), at = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ct, defineProperty: dt, getOwnPropertyDescriptor: pt, getOwnPropertyNames: ut, getOwnPropertySymbols: $t, getPrototypeOf: _t } = Object, N = globalThis, F = N.trustedTypes, ft = F ? F.emptyScript : "", At = N.reactiveElementPolyfillSupport, E = (r, t) => r, H = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? ft : null;
      break;
  ...
  return e;
} }, z = (r, t) => !ct(r, t), J = { attribute: !0, type: String, converter: H, reflect: !1, useDefault: !1, hasChanged: z };
...
y.elementStyles = [], y.shadowRootOptions = { mode: "open" }, y[E("elementProperties")] = /* @__PURE__ */ new Map(), y[E("finalized")] = /* @__PURE__ */ new Map(), At?.({ ReactiveElement: y }), (N.reactiveElementVersions ??= []).push("2.1.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const L = globalThis, T = L.trustedTypes, K = T ? T.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, et = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, st = "?" + _, mt = `<${st}>`, m = document, w = () => m.createComment(""), C = (r) => r === null || typeof r != "object" && typeof r != "function", B = Array.isArray, yt = (r) => B(r) || typeof r?.[Symbol.iterator] == "function", k = `[ 	
\f\r]`, b = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Z = /-->/g, G = />/g, f = RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Q = /'/g, X = /"/g, it = /^(?:script|style|textarea|title)$/i, gt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), vt = gt(1), g = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), Y = /* @__PURE__ */ new WeakMap(), A = m.createTreeWalker(m, 129);
function rt(r, t) {
...
const bt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === b ? p[1] === "!--" ? o = Z : p[1] !== void 0 ? o = G : p[2] !== void 0 ? (it.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = f) : p[3] !== void 0 && (o = f) : o === f ? p[0] === ">" ? (o = i ?? b, l = -1) : p[1] === void 0 ? l = -2 : (l = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? f : p[3] === '"' ? X : Q) : o === X || o === Q ? o = f : o === Z || o === G ? o = b : (o = f, i = void 0);
    const $ = o === f && r[a + 1].startsWith("/>") ? " " : "";
    n += o === b ? h + mt : l >= 0 ? (s.push(c), h.slice(0, l) + et + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
    ...
    for (; (i = A.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(et)) {
          ...
          h.push({ type: 1, index: n, name: U[2], strings: $, ctor: U[1] === "." ? St : U[1] === "?" ? wt : U[1] === "@" ? Ct : R }), i.removeAttribute(l);
...
class Et {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (o === h.index) {
        let c;
        h.type === 2 ? c = new O(n, n.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(n, h.name, h.strings, this, t) : h.type === 6 && (c = new Pt(n, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class O {
  ...
  _$AI(t, e = this) {
    t = v(this, t, e), C(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== g && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : yt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
xt?.(P, O), (L.litHtmlVersions ??= []).push("3.3.0");
const Ot = (r, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ht = { attribute: !0, type: String, converter: H, reflect: !1, hasChanged: z }, Tt = (r = Ht, t, e) => {
...
var ot = Object.defineProperty, Rt = Object.getOwnPropertyDescriptor, kt = (r, t, e) => t in r ? ot(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e, q = (r, t, e, s) => {
...
let x = class extends S {
  ...
  count = 0;
  updated(r) {
    r.has("count") && console.log(`Clicked ${this.count} times`);
  }
  handleClick() {
    this.count += 1;
  }
